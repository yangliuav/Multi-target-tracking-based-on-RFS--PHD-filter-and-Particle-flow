function vgset = particleFlowPHD(sensor,setup,z_current,Cz)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for lambda = setup.lambda_range
    ...
    if  size(vgset,1) ~= 0
        [slope, log_jExampleobian_det] = calculateSlopePHD(z_current,vgset,setup,lambda,step_size,Cz);
    end
