function [output,position] = SMCPHD(setup,z)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for tt = 1:size(z,2)
    ...
    %        set(h_leg,'FontSize',fontsize,'Location','southeast');
            ...
            switch setup.pf_type
                ...
                case 'NPFS'
                    path = [path, '/NPFS/'];
                    title(['Particles of NPF-SMC-PHD_S filter before resampling and clipping at k = ',num2str(tt)],'FontSize',16);
                case 'SMC'
                    path = [path, '/SMC/'];
                    title(['Particles of SMC-PHD filter before resampling and clipping at k = ',num2str(tt)],'FontSize',16);
            end  
