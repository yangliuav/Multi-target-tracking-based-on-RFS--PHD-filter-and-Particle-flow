% The folder "SMAV\Core_files" contains the codes for the following
% algorithms:
% Baseline Visual SMC-PHD (\V_SMC_PHD)
% Proposed Audio-visual SMC-PHD (\AV_SMC_PHD)
% Proposed Mean-Shift based Audio-visual SMC-PHD (\AVMS_SMC_PHD)
% Proposed Sparse Sampling for AVMS-SMC-PHD (\sparse_AVMS_SMC_PHD)
%
% This folder also contains some files under "DATA" folder to use in
...
%
% The codes & data have been deposited to http://dx.doi.org/10.15126/surreydata.00XXXXXX.
%
...
%     
% Copyright 2016 V. Kilic, M. Barnard, W. Wang, A. Hilton and J. Kittler
% 
